...
export type RadioButtonVariantProps = VariantProps<typeof radioButtonStyles>;
type RadioButtonSlotProps = Parameters<
  ReturnType<typeof radioButtonStyles>["root"]
>[0];

export function radioButtonVariants() {
...
export type RadioButtonProps = React.ComponentPropsWithRef<typeof RACRadio>;
...
export function RadioButton({
  ...
  const { control, dot, icon, label, root } = radioButtonVariants();
...
export type RadioGroupProps = React.ComponentPropsWithRef<typeof RACRadioGroup>;
...
export type RadioGroupLabelProps = React.ComponentPropsWithRef<typeof RACLabel>;

export function RadioGroupLabel({ className, ...props }: RadioGroupLabelProps) {
  const { label } = radioGroupVariants();
...
export type RadioGroupDescriptionProps = React.ComponentPropsWithRef<
  typeof RACText
>;
...
export function RadioGroupDescription({
  ...
  const { description } = radioGroupVariants();
...
export type RadioGroupErrorProps = React.ComponentPropsWithRef<
  typeof RACFieldError
>;

export function RadioGroupError({ className, ...props }: RadioGroupErrorProps) {
  const { error } = radioGroupVariants();
