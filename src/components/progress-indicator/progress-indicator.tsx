...
export type ProgressIndicatorVariantProps = VariantProps<
  typeof progressIndicatorStyles
>;
type ProgressIndicatorSlotProps = Parameters<
  ReturnType<typeof progressIndicatorStyles>["root"]
>[0];

export function progressIndicatorVariants() {
...
export type LinearProgressIndicatorProps = React.ComponentPropsWithRef<
...
export type CircularProgressIndicatorProps = React.ComponentPropsWithRef<
  typeof RACProgressBar
>;
...
export function CircularProgressIndicator({
  ...
  const { header, label, output, root } = progressIndicatorVariants();
