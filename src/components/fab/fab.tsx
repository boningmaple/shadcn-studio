...
export const fabButtonVariants = tv({
  base: [
...
export type FABButtonProps = Omit<ButtonProps, "shape" | "size" | "variant"> &
  VariantProps<typeof fabButtonVariants>;
  ...
  return (
    <Button
      className={composeRenderProps(className, (className) =>
        fabButtonVariants({ className, color, lowered, size }),
      )}
      data-color={color}
