...
export default function BottomSheetDemo() {
  return (
    <BottomSheet defaultSnapPoint="18rem" snapPoints={["18rem", 0.86]}>
      <BottomSheetTrigger render={<Button variant="outlined" />}>
        Open snapping sheet
      </BottomSheetTrigger>
      <BottomSheetContent height="tall" inset>
        <BottomSheetHeader>
          <BottomSheetTitle>Today in Sydney</BottomSheetTitle>
          <BottomSheetDescription>
