...
export type MDLoadingIndicatorVariantProps = VariantProps<
  typeof mdLoadingIndicatorStyles
>;
type LoadingIndicatorSlotProps = Parameters<
  ReturnType<typeof mdLoadingIndicatorStyles>["root"]
>[0];
