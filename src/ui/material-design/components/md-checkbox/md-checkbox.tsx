...
type CheckboxSlotProps = Parameters<
  ReturnType<typeof mdCheckboxStyles>["root"]
>[0];
...
export type MDCheckboxGroupProps = React.ComponentPropsWithRef<
...
export type MDCheckboxGroupLabelProps = React.ComponentPropsWithRef<
  typeof RACLabel
>;

export function MDCheckboxGroupLabel({
  className,
  ...props
}: MDCheckboxGroupLabelProps) {
...
export type MDCheckboxGroupDescriptionProps = React.ComponentPropsWithRef<
  typeof RACText
>;
...
export type MDCheckboxGroupErrorProps = React.ComponentPropsWithRef<
  typeof RACFieldError
>;

export function MDCheckboxGroupError({
  className,
  ...props
}: MDCheckboxGroupErrorProps) {
