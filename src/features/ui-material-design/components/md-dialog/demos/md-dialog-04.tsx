...
} from "@/features/ui-material-design/components/md-dialog/md-dialog";
    ...
    <MDDialogTrigger>
      ...
      <MDFullScreenDialog>
        ...
        <MDFullScreenDialogContent className="mx-auto grid w-full max-w-3xl gap-4">
          <p>
            Full-screen dialogs support complex tasks that need more room than a standard dialog.
          </p>
          <div className="grid gap-3 rounded-[16px] bg-[#f7f2fa] p-4 dark:bg-[#211f26]">
            <span className="font-medium text-[#1d1b20] dark:text-[#e6e0e9]">Contact details</span>
            <span>Add profile fields, review permissions, and save when the task is complete.</span>
          </div>
        </MDFullScreenDialogContent>
      </MDFullScreenDialog>
    </MDDialogTrigger>
