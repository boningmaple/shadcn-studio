    ...
    <div className="grid w-full max-w-3xl overflow-hidden rounded-[16px] border border-[#cac4d0] bg-[#fffbfe] md:grid-cols-[minmax(0,1fr)_auto] dark:border-[#49454f] dark:bg-[#1d1b20]">
      <div className="grid min-h-[28rem] gap-4 p-6">
        <div className="grid content-start gap-2">
          <span className="text-sm font-medium text-[#6750a4] dark:text-[#d0bcff]">Board</span>
          ...
          <p className="max-w-md text-sm leading-6 text-[#49454f] dark:text-[#cac4d0]">
            Standard side sheets keep supporting details visible while the main workspace remains
            available.
          </p>
        </div>
      ...
      <MDStandardSideSheet>
        ...
        <MDSideSheetBody className="grid content-start gap-4">
          <MDSideSheetDescription>
            The selected board has 14 assets, 3 pending approvals, and one scheduled handoff.
          </MDSideSheetDescription>
          <dl className="grid gap-3">
            <div className="grid gap-1">
              <dt className="text-xs font-medium text-[#49454f] dark:text-[#cac4d0]">Owner</dt>
              <dd className="text-base text-[#1d1b20] dark:text-[#e6e0e9]">Product marketing</dd>
            </div>
            <div className="grid gap-1">
              <dt className="text-xs font-medium text-[#49454f] dark:text-[#cac4d0]">Due</dt>
              <dd className="text-base text-[#1d1b20] dark:text-[#e6e0e9]">Friday, 4:00 PM</dd>
            </div>
          </dl>
        </MDSideSheetBody>
      </MDStandardSideSheet>
