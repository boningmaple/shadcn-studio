...
} from "@/features/ui-material-design/components/md-bottom-sheet/md-bottom-sheet";
...
export default function MDBottomSheetDemo() {
  return (
    <MDBottomSheet>
      ...
      <MDBottomSheetContent>
        <MDBottomSheetHeader>
          <MDBottomSheetTitle>Project actions</MDBottomSheetTitle>
          <MDBottomSheetDescription>
            Choose one quick action for the current board.
          </MDBottomSheetDescription>
        </MDBottomSheetHeader>
        <MDBottomSheetBody className="px-0 pb-4">
            ...
            {actions.map((action) => (
              ...
              >
                ...
                <span className="grid min-w-0">
                  <span className="truncate text-base leading-6">{action.label}</span>
