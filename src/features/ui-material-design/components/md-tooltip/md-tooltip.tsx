...
type TooltipSlotProps = Parameters<ReturnType<typeof mdTooltipStyles>["plain"]>[0];
...
export type MDTooltipTriggerProps = React.ComponentPropsWithRef<typeof RACTooltipTrigger>;
...
export function MDTooltipTrigger({
  ...
  return (
    <RACTooltipTrigger closeDelay={closeDelay} data-slot="tooltip-trigger" delay={delay} {...props}>
...
export function MDTooltip({ className, offset = 8, placement = "top", ...props }: MDTooltipProps) {
...
export function MDRichTooltip({
  ...
  const { richActions, richContent, richDialog, richPopover, richTitle } = mdTooltipVariants();
