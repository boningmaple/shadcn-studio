...
import {
  ...
  MDTooltip,
  MDTooltipTrigger,
} from "@/features/ui-material-design/components/md-tooltip/md-tooltip";
    ...
    <div className="flex w-full max-w-xl flex-wrap items-center justify-center gap-3">
      ...
      <MDRichTooltipTrigger>
        ...
        <MDRichTooltip placement="bottom end" title="Delivery details">
          Updates go to everyone following this workspace and stay editable for five minutes after
          sending.
        </MDRichTooltip>
      </MDRichTooltipTrigger>
    </div>
