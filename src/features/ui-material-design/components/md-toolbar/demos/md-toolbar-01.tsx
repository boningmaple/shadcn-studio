import { ArrowLeftIcon, BellIcon, MoreVerticalIcon, SearchIcon } from "lucide-react";

import { MDIconButton } from "@/features/ui-material-design/components/md-icon-button/md-icon-button";
import { MDTextField } from "@/features/ui-material-design/components/md-text-field/md-text-field";
import {
  MDToolbar,
  MDToolbarGroup,
  MDToolbarSpacer,
