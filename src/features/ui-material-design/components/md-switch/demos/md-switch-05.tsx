...
import { MDSwitch } from "@/features/ui-material-design/components/md-switch/md-switch";

export default function MDSwitchDemo() {
  return (
    <div className="grid w-full max-w-sm gap-1">
      <MDSwitch className="w-full flex-row-reverse justify-between gap-4" defaultSelected>
        <span className="flex items-center gap-3">
          <BellIcon aria-hidden="true" className="size-5 text-[#49454f] dark:text-[#cac4d0]" />
      ...
      <MDSwitch className="w-full flex-row-reverse justify-between gap-4">
        <span className="flex items-center gap-3">
          <MailIcon aria-hidden="true" className="size-5 text-[#49454f] dark:text-[#cac4d0]" />
          <span className="grid gap-0.5">
