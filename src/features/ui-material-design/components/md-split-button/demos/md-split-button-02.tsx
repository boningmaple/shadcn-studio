...
} from "@/features/ui-material-design/components/md-split-button/md-split-button";
  ...
  return (
    <div className="flex w-full flex-wrap items-center justify-center gap-4">
      <MDSplitButton
        menuItems={
          <>
            <MDSplitButtonMenuItem icon={<ArchiveIcon />}>Archive draft</MDSplitButtonMenuItem>
            <MDSplitButtonMenuItem icon={<StarIcon />}>Mark important</MDSplitButtonMenuItem>
          </>
        }
        variant="tonal"
      >
