...
export default function MDTabsDemo() {
  return (
    <div className="grid w-full gap-8 xl:grid-cols-2">
      <MDTabs className="min-h-64" defaultSelectedKey="profile" orientation="vertical">
        ...
        <MDTabPanels>
          ...
          <MDTabPanel id="security">Review sign-in and security settings.</MDTabPanel>
          <MDTabPanel id="billing">Manage billing details and invoices.</MDTabPanel>
        </MDTabPanels>
      </MDTabs>
      ...
      >
        ...
        <MDTabPanels>
          ...
          <MDTabPanel id="files">Browse files shared with the project.</MDTabPanel>
        </MDTabPanels>
      </MDTabs>
    </div>
  );
