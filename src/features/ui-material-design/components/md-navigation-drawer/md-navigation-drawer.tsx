...
import { MDDivider } from "@/features/ui-material-design/components/md-divider/md-divider";
import {
  MDModalSideSheet,
  MDSideSheetTrigger,
  MDStandardSideSheet,
...
} from "@/features/ui-material-design/components/md-side-sheet/md-side-sheet";
...
export function mdNavigationDrawerVariants() {
  ...
  return {
    ...
    sectionHeader: (props?: NavigationDrawerSlotProps) => styles.sectionHeader(props),
    standard: (props?: NavigationDrawerSlotProps) => styles.standard(props),
    supportingText: (props?: NavigationDrawerSlotProps) => styles.supportingText(props),
  };
}

export type MDNavigationDrawerTriggerProps = React.ComponentPropsWithRef<typeof MDSideSheetTrigger>;

export function MDNavigationDrawerTrigger(props: MDNavigationDrawerTriggerProps) {
...
export function MDStandardNavigationDrawer({
  ...
  return (
    <MDStandardSideSheet className={standard({ className })} side={side} width={width} {...props} />
  );
}

export type MDModalNavigationDrawerProps = Omit<MDModalSideSheetProps, "className"> & {
  className?: string;
};
...
export function MDModalNavigationDrawer({
  ...
  return <MDModalSideSheet className={modal({ className })} side={side} {...props} />;
}

export type MDNavigationDrawerHeaderProps = React.ComponentPropsWithRef<"div"> & {
...
export function MDNavigationDrawerHeader({
  ...
  return (
    <div className={header({ className })} data-slot="navigation-drawer-header" {...props}>
      ...
      {supportingText === undefined ? null : (
        <span className={supportingTextSlot()} data-slot="navigation-drawer-supporting-text">
          {supportingText}
        </span>
      )}
      {children}
...
export type MDNavigationDrawerSectionProps = React.ComponentPropsWithRef<"div"> & {
  ...
  return (
    ...
    >
      {title === undefined ? null : (
        <span className={sectionHeader()} data-slot="navigation-drawer-section-header">
          {title}
        </span>
      )}
      {children}
...
export type MDNavigationDrawerItemProps = Omit<RACLinkProps, "children" | "className"> & {
...
export type MDNavigationDrawerDividerProps = React.ComponentPropsWithRef<typeof MDDivider>;
...
export function MDNavigationDrawerDivider({
  ...
  return <MDDivider className={divider({ className })} inset={inset} {...props} />;
}
