...
type TextFieldSlotProps = Parameters<ReturnType<typeof mdTextFieldStyles>["root"]>[0];
...
export function MDTextField({
  ...
  const labelOffset =
    startContent !== undefined || prefix !== undefined ? "startContent" : "normal";
      ...
      <div className={container({ variant })} data-slot="text-field-container">
        {startContent === undefined ? null : (
          <span className={leading()} data-slot="text-field-leading">
            <RACProvider values={[[ButtonContext, {}]]}>{startContent}</RACProvider>
          </span>
        )}
        ...
        {trailingIcon === undefined ? null : (
          <span className={trailing()} data-slot="text-field-trailing">
            <RACProvider values={[[ButtonContext, {}]]}>{trailingIcon}</RACProvider>
          </span>
        )}
      </div>
      {resolvedDescription === undefined && errorMessage === undefined ? null : (
