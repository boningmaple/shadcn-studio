import { MDCheckbox } from "@/features/ui-material-design/components/md-checkbox/md-checkbox";
import { MDList, MDListItem } from "@/features/ui-material-design/components/md-list/md-list";
    ...
    <div className="w-full max-w-sm overflow-hidden bg-[#fffbfe] shadow-[0_1px_2px_0_rgb(0_0_0/0.3),0_1px_3px_1px_rgb(0_0_0/0.15)] dark:bg-[#1d1b20]">
      ...
      >
        <MDListItem
          ...
          start={<MDCheckbox aria-label="Select launch copy" slot="selection" />}
        ...
        <MDListItem
          ...
          isDisabled
          start={<MDCheckbox aria-label="Select support handoff" slot="selection" />}
