...
import {
  MDCheckbox,
  MDCheckboxGroup,
} from "@/features/ui-material-design/components/md-checkbox/md-checkbox";
...
export default function MDCheckboxDemo() {
  ...
  return (
    <div className="grid w-full max-w-sm gap-2">
      <MDCheckbox isIndeterminate={isIndeterminate} isSelected={allSelected} onChange={toggleAll}>
