import { MDToggleButton } from "@/features/ui-material-design/components/md-toggle-button/md-toggle-button";
...
function ToggleButtonStateRow({ isSelected, label }: { isSelected: boolean; label: string }) {
  return (
    <div className="grid gap-3">
      <p className="text-center text-sm font-medium text-muted-foreground">{label}</p>
      <div className="flex flex-wrap items-center justify-center gap-4">
        <MDToggleButton isSelected={isSelected} variant="filled">
          Enabled
        </MDToggleButton>
        <MDToggleButton isDisabled isSelected={isSelected} variant="filled">
          Disabled
        </MDToggleButton>
        <MDToggleButton className="before:opacity-[0.08]" isSelected={isSelected} variant="filled">
          Hovered
        </MDToggleButton>
        <MDToggleButton
