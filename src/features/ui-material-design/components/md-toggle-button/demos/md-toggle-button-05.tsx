  ...
  return (
    <div className="grid gap-3">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <MDToggleButton isSelected={isSelected} variant="tonal">
          Enabled
        </MDToggleButton>
        <MDToggleButton isDisabled isSelected={isSelected} variant="tonal">
          Disabled
        </MDToggleButton>
        <MDToggleButton className="before:opacity-[0.08]" isSelected={isSelected} variant="tonal">
          Hovered
        </MDToggleButton>
        <MDToggleButton
