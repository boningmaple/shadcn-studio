...
export const mdToggleButtonVariants = tv({
  base: [
...
export type MDToggleButtonProps = React.ComponentPropsWithRef<typeof RACToggleButton> &
  VariantProps<typeof mdToggleButtonVariants>;

export function MDToggleButton({
  className,
  variant = "filled",
  size = "sm",
  shape = "round",
  ...
  return (
    <RACToggleButton
      ...
      className={composeRenderProps(className, (className) =>
        mdToggleButtonVariants({ variant, size, shape, className }),
      )}
      {...props}
    />
  );
