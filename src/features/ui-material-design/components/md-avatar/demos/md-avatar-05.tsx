...
import { Avatar, AvatarFallback, AvatarImage } from "@/features/ui-shadcn/react-aria/avatar";
import { Badge } from "@/features/ui-shadcn/react-aria/badge";

export default function MDAvatarDemo() {
  return (
    <div className="flex flex-wrap items-center justify-center gap-10">
      <div className="relative">
        <Avatar className="ring-2 ring-rose-500 ring-offset-2 ring-offset-background" size="lg">
          <AvatarImage
      ...
      <div className="relative">
        <Avatar className="ring-2 ring-emerald-500 ring-offset-2 ring-offset-background" size="lg">
          <AvatarImage
