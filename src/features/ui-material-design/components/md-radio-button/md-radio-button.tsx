...
export type MDRadioButtonVariantProps = VariantProps<typeof mdRadioButtonStyles>;
type RadioButtonSlotProps = Parameters<ReturnType<typeof mdRadioButtonStyles>["root"]>[0];
...
export function MDRadioButton({ children, className, ...props }: MDRadioButtonProps) {
...
type RadioGroupSlotProps = Parameters<ReturnType<typeof radioGroupStyles>["group"]>[0];
...
export type MDRadioGroupProps = React.ComponentPropsWithRef<typeof RACRadioGroup>;
...
export type MDRadioGroupLabelProps = React.ComponentPropsWithRef<typeof RACLabel>;

export function MDRadioGroupLabel({ className, ...props }: MDRadioGroupLabelProps) {
  const { label } = mdRadioGroupVariants();

  return <RACLabel className={label({ className })} data-slot="radio-group-label" {...props} />;
}

export type MDRadioGroupDescriptionProps = React.ComponentPropsWithRef<typeof RACText>;
...
export type MDRadioGroupErrorProps = React.ComponentPropsWithRef<typeof RACFieldError>;

export function MDRadioGroupError({ className, ...props }: MDRadioGroupErrorProps) {
