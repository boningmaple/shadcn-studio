...
import {
  ...
  MDTabPanels,
  MDTabs,
} from "@/features/ui-material-design/components/md-tabs/md-tabs";
      ...
      <MDTabs defaultSelectedKey="home" onSelectionChange={selectDestination}>
        <MDTabList aria-label="App destinations">
          ...
          >
            <MDBadgeAnchor>
              <MailIcon />
              {unreadCount > 0 ? <MDBadge aria-hidden="true">{unreadCount}</MDBadge> : null}
            </MDBadgeAnchor>
            Messages
          </MDTab>
          <MDTab id="settings">
        ...
        <MDTabPanels>
          <MDTabPanel id="home">Review your latest account activity.</MDTabPanel>
          <MDTabPanel id="messages">Your messages are up to date.</MDTabPanel>
          <MDTabPanel id="settings">Manage notification preferences.</MDTabPanel>
        </MDTabPanels>
      </MDTabs>
