...
export default function MDChipsDemo() {
  const [message, setMessage] = React.useState("Choose a suggestion to continue.");
  ...
  return (
    <div className="grid w-full gap-5">
      ...
      <MDChipGroup aria-label="Elevated suggestions" surface="elevated" variant="suggestion">
        <MDChipList className="justify-center">
          <MDChip
            id="surprise-me"
            icon={<SparklesIcon />}
          ...
          <MDChip id="popular-now" onAction={() => setMessage("Popular ideas opened.")}>
            Popular now
          </MDChip>
        </MDChipList>
      </MDChipGroup>
