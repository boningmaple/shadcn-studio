...
export default function MDChipsDemo() {
  const [message, setMessage] = React.useState("Choose an assist chip to perform an action.");
  ...
  return (
    <div className="grid w-full gap-5">
      ...
      <MDChipGroup aria-label="Elevated assist actions" surface="elevated" variant="assist">
        <MDChipList className="justify-center">
          <MDChip
            id="remind-me"
            icon={<Clock3Icon />}
