...
import {
  ...
  MDCardContent,
  MDCardHeader,
} from "@/features/ui-material-design/components/md-card/md-card";
      ...
      <MDCardHeader>
        <div className="flex items-start justify-between gap-4">
          <div className="grid gap-1">
            <span className="text-base leading-6 font-medium">Release readiness</span>
            <span className="text-sm leading-5 text-[#49454f] dark:text-[#cac4d0]">
              Design system checklist
            </span>
          </div>
          <MDBadgeAnchor>
            <MDIconButton aria-label="More actions" size="xs" variant="standard">
              <MoreVerticalIcon />
            </MDIconButton>
            <MDBadge>3</MDBadge>
          </MDBadgeAnchor>
