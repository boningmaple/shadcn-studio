...
export default function MDCardDemo() {
  return (
    <MDCard className="w-full max-w-sm" variant="filled">
      ...
      <MDCardHeader>
        <div className="flex items-start justify-between gap-4">
          <div className="grid gap-1">
            <span className="text-base leading-6 font-medium">Daily design brief</span>
      ...
      <MDCardContent>
        A compact card can combine media, supporting text, and a small action set around one
        subject.
      </MDCardContent>
      <MDCardActions>
