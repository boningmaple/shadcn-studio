...
import SideSheet01 from "@/demos/components/side-sheet/side-sheet-01";
import SideSheet02 from "@/demos/components/side-sheet/side-sheet-02";
import SideSheet03 from "@/demos/components/side-sheet/side-sheet-03";
import SideSheet04 from "@/demos/components/side-sheet/side-sheet-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/side-sheet")({
