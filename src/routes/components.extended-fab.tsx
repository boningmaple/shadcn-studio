...
import ExtendedFAB01 from "@/demos/components/extended-fab/extended-fab-01";
import ExtendedFAB02 from "@/demos/components/extended-fab/extended-fab-02";
import ExtendedFAB03 from "@/demos/components/extended-fab/extended-fab-03";
import ExtendedFAB04 from "@/demos/components/extended-fab/extended-fab-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/extended-fab")({
...
function ExtendedFABComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="extended-fab"
