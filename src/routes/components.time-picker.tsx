...
import TimePicker01 from "@/demos/components/time-picker/time-picker-01";
import TimePicker02 from "@/demos/components/time-picker/time-picker-02";
import TimePicker03 from "@/demos/components/time-picker/time-picker-03";
import TimePicker04 from "@/demos/components/time-picker/time-picker-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/time-picker")({
...
function TimePickerComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="time-picker"
