...
import NavigationBar01 from "@/demos/components/navigation-bar/navigation-bar-01";
import NavigationBar02 from "@/demos/components/navigation-bar/navigation-bar-02";
import NavigationBar03 from "@/demos/components/navigation-bar/navigation-bar-03";
import NavigationBar04 from "@/demos/components/navigation-bar/navigation-bar-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/navigation-bar")({
...
function NavigationBarComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="navigation-bar"
