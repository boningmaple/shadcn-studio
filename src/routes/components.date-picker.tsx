...
import DatePicker01 from "@/demos/components/date-picker/date-picker-01";
import DatePicker02 from "@/demos/components/date-picker/date-picker-02";
import DatePicker03 from "@/demos/components/date-picker/date-picker-03";
import DatePicker04 from "@/demos/components/date-picker/date-picker-04";
import {
...
function DatePickerComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="date-picker"
