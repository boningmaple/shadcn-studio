...
import NavigationRail01 from "@/demos/components/navigation-rail/navigation-rail-01";
import NavigationRail02 from "@/demos/components/navigation-rail/navigation-rail-02";
import NavigationRail03 from "@/demos/components/navigation-rail/navigation-rail-03";
import NavigationRail04 from "@/demos/components/navigation-rail/navigation-rail-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/navigation-rail")({
...
function NavigationRailComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="navigation-rail"
