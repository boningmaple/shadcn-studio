...
import ButtonGroup01 from "@/demos/components/button-group/button-group-01";
import ButtonGroup02 from "@/demos/components/button-group/button-group-02";
import ButtonGroup03 from "@/demos/components/button-group/button-group-03";
import ButtonGroup04 from "@/demos/components/button-group/button-group-04";
import {
...
function ButtonGroupComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="button-group"
