...
import TextField01 from "@/material-3-ui/components/m3-text-field/demos/m3-text-field-01";
import TextField02 from "@/material-3-ui/components/m3-text-field/demos/m3-text-field-02";
import TextField03 from "@/material-3-ui/components/m3-text-field/demos/m3-text-field-03";
import TextField04 from "@/material-3-ui/components/m3-text-field/demos/m3-text-field-04";
import TextField05 from "@/material-3-ui/components/m3-text-field/demos/m3-text-field-05";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/material-3-ui/components/text-field")({
...
function TextFieldComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="m3-text-field"
