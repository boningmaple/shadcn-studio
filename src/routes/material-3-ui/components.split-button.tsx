...
import SplitButton01 from "@/material-3-ui/components/m3-split-button/demos/m3-split-button-01";
import SplitButton02 from "@/material-3-ui/components/m3-split-button/demos/m3-split-button-02";
import SplitButton03 from "@/material-3-ui/components/m3-split-button/demos/m3-split-button-03";
import SplitButton04 from "@/material-3-ui/components/m3-split-button/demos/m3-split-button-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/material-3-ui/components/split-button")({
...
function SplitButtonComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="m3-split-button"
