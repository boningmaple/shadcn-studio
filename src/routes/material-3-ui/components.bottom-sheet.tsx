...
import BottomSheet01 from "@/material-3-ui/components/m3-bottom-sheet/demos/m3-bottom-sheet-01";
import BottomSheet02 from "@/material-3-ui/components/m3-bottom-sheet/demos/m3-bottom-sheet-02";
import BottomSheet03 from "@/material-3-ui/components/m3-bottom-sheet/demos/m3-bottom-sheet-03";
import BottomSheet04 from "@/material-3-ui/components/m3-bottom-sheet/demos/m3-bottom-sheet-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/material-3-ui/components/bottom-sheet")({
...
function BottomSheetComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="m3-bottom-sheet"
