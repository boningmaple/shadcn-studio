...
import DatePicker01 from "@/material-3-ui/components/m3-date-picker/demos/m3-date-picker-01";
import DatePicker02 from "@/material-3-ui/components/m3-date-picker/demos/m3-date-picker-02";
import DatePicker03 from "@/material-3-ui/components/m3-date-picker/demos/m3-date-picker-03";
import DatePicker04 from "@/material-3-ui/components/m3-date-picker/demos/m3-date-picker-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/material-3-ui/components/date-picker")({
...
function DatePickerComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="m3-date-picker"
