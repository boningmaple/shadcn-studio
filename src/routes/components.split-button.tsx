...
import SplitButton01 from "@/demos/components/split-button/split-button-01";
import SplitButton02 from "@/demos/components/split-button/split-button-02";
import SplitButton03 from "@/demos/components/split-button/split-button-03";
import SplitButton04 from "@/demos/components/split-button/split-button-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/split-button")({
...
function SplitButtonComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="split-button"
