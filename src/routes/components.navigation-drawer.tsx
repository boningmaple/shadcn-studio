...
import NavigationDrawer01 from "@/demos/components/navigation-drawer/navigation-drawer-01";
import NavigationDrawer02 from "@/demos/components/navigation-drawer/navigation-drawer-02";
import NavigationDrawer03 from "@/demos/components/navigation-drawer/navigation-drawer-03";
import NavigationDrawer04 from "@/demos/components/navigation-drawer/navigation-drawer-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/navigation-drawer")({
...
function NavigationDrawerComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="navigation-drawer"
