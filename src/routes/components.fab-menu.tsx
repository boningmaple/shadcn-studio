...
import FABMenu01 from "@/demos/components/fab-menu/fab-menu-01";
import FABMenu02 from "@/demos/components/fab-menu/fab-menu-02";
import FABMenu03 from "@/demos/components/fab-menu/fab-menu-03";
import FABMenu04 from "@/demos/components/fab-menu/fab-menu-04";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/fab-menu")({
