...
import ProgressIndicator01 from "@/demos/components/progress-indicator/progress-indicator-01";
import ProgressIndicator02 from "@/demos/components/progress-indicator/progress-indicator-02";
import ProgressIndicator03 from "@/demos/components/progress-indicator/progress-indicator-03";
import ProgressIndicator04 from "@/demos/components/progress-indicator/progress-indicator-04";
import ProgressIndicator05 from "@/demos/components/progress-indicator/progress-indicator-05";
import {
  ComponentExamplesPage,
  type ComponentExample,
} from "@/components/component-examples-page";

export const Route = createFileRoute("/components/progress-indicator")({
...
function ProgressIndicatorComponentPage() {
  return (
    <ComponentExamplesPage
      codeArtifactPrefix="progress-indicator"
