...
export const m3SliderStyles = tv({
  slots: {
    root: [
...
export type M3SliderVariantProps = VariantProps<typeof m3SliderStyles>;
type SliderSlotProps = Parameters<ReturnType<typeof m3SliderStyles>["root"]>[0];

export function m3SliderVariants() {
  const styles = m3SliderStyles();
...
export type M3SliderProps = React.ComponentPropsWithRef<typeof RACSlider> & {
...
export type M3RangeSliderProps = M3SliderProps;

export function M3RangeSlider(props: M3RangeSliderProps) {
  return <M3Slider {...props} />;
}
