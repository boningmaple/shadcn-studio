...
export const m3TextFieldStyles = tv({
  slots: {
    root: [
...
export type M3TextFieldVariantProps = VariantProps<typeof m3TextFieldStyles>;
type TextFieldSlotProps = Parameters<
  ReturnType<typeof m3TextFieldStyles>["root"]
>[0];

export function m3TextFieldVariants() {
  const styles = m3TextFieldStyles();
...
export type M3TextAreaProps = Omit<
  React.ComponentPropsWithRef<typeof RACTextField>,
  "children" | "description" | "errorMessage"
> &
  VariantProps<typeof m3TextFieldStyles> & {
