...
export const m3ToggleButtonVariants = tv({
  base: [
...
export type M3ToggleButtonProps = React.ComponentPropsWithRef<
  typeof RACToggleButton
> &
  VariantProps<typeof m3ToggleButtonVariants>;

export function M3ToggleButton({
  className,
  variant = "filled",
  size = "sm",
  shape = "round",
  ...
  return (
    <RACToggleButton
      ...
      className={composeRenderProps(className, (className) =>
        m3ToggleButtonVariants({ variant, size, shape, className }),
      )}
      {...props}
    />
  );
