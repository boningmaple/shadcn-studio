...
export const m3DividerVariants = tv({
...
export type M3DividerProps = Omit<
  React.ComponentPropsWithRef<typeof RACSeparator>,
  "orientation"
> &
  VariantProps<typeof m3DividerVariants>;
...
export function M3Divider({
  ...
  return (
    <RACSeparator
      ...
      className={m3DividerVariants({ className, inset, orientation })}
      {...props}
    />
  );
}
